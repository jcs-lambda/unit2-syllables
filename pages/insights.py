...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            It is fun to find words that are classified incorrectly and play around with groups or variations of words. I also enjoyed attempting to
            identify where the model is failing, and maybe figure out why. It is pretty cool to see the model's output
            in real time.
            ...
            As you can see in the image below, my final model made the most use of the 'chunk' features; and the majority of my later
            ...
            I used a shallow decision tree to establish a baseline score. As shown in the graph below, the tree establishes the 'chunk' features as the most important variable in deciding when to split.
            You can click the image to view the next row as well.
            ...
            While working through models and features, keeping an eye on the macro averages of precision and recall allowed me to
            realize when my feature engineering and parameter tuning were going off track.
